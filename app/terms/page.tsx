...
export const metadata = createPageMetadata({
  title: "Terms of Use",
  description:
    "Terms for using the independent Amul Stock Checker, including limits, acceptable use, third-party services, and the unofficial project disclaimer.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <SeoPage
      title="Terms of Use"
      description="These are the basic rules and limitations that apply when you use Amul Stock Checker."
      path="/terms"
      showCta={false}
    >
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          agree, do not create an alert or use the site. The project may
      ...
      <section className="space-y-4">
        <h2>Independent alert service</h2>
        <p>
          ...
          The site runs scheduled stock checks and sends alerts. It is not a
          retailer, purchasing agent, inventory provider, or part of Amul Shop.
        </p>
      </section>

      <section className="space-y-4">
        <h2>No stock or delivery guarantee</h2>
        <p>
          ...
          after an alert is sent. A message does not reserve inventory,
        ...
        <p>
          ...
          terms, and payment details directly on Amul Shop before making
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>attempt to bypass sign-in, access another user&apos;s alerts, or obtain server credentials;</li>
      ...
      <section className="space-y-4">
        ...
        <p>
          The site is provided on an as-available basis. Features, schedules,
          integrations, or access may change, pause, or stop without notice.
          We do not promise uninterrupted, error-free, or permanently free
      ...
      <section className="space-y-4">
        ...
        <p>
          To the maximum extent permitted by applicable law, the site is
          ...
          liable for missed stock, missed or delayed messages, purchasing
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          information about sign-in, alerts, analytics, location
